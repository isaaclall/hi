...
import sty from "./PlasmicPageLayout.module.css"; // plasmic-import: EfKfod4ELb5/css
import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: UBAZu2FyVRX/icon
import Icon2Icon from "./icons/PlasmicIcon__Icon2"; // plasmic-import: OER_NrJFxJD/icon
...
function PlasmicPageLayout__RenderFunc(props) {
  ...
  return (
    <RichLayout
      ...
      logoElement={
        <Icon2Icon
          className={classNames(projectcss.all, sty.svg__oshgh)}
          role={"img"}
        />
      }
      navMenuItems={[
    ...
    >
      <LoadingBoundary
        ...
        loadingState={
          <ph.DataCtxReader>
            {$ctx =>
              true ? (
                <div className={classNames(projectcss.all, sty.freeBox__tU0Kc)}>
                  <IconIcon
                    className={classNames(projectcss.all, sty.svg__ya2I)}
                    role={"img"}
                  />
                </div>
              ) : null
      ...
      >
        <ph.DataCtxReader>
          {$ctx =>
            true ? (
              <div className={classNames(projectcss.all, sty.freeBox__za3Te)}>
                {p.renderPlasmicSlot({
                  defaultContents: (
                    <section
                      className={classNames(projectcss.all, sty.section__oUjNh)}
                    >
                      <h1
                        className={classNames(
                          projectcss.all,
